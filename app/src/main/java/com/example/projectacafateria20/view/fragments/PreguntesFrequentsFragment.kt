 ...
 * Use the [PreguntesFrequentsFragment.newInstance] factory method to
...
class PreguntesFrequentsFragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment PreguntesFrequentsFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            PreguntesFrequentsFragment().apply {
