 ...
 * Use the [HistorialComandesFragment.newInstance] factory method to
...
class HistorialComandesFragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment HistorialComandesFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            HistorialComandesFragment().apply {
